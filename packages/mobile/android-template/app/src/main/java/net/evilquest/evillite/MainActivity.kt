...
class MainActivity : BridgeActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Persist evilquest.net session cookies across launches.
        CookieManager.getInstance().apply {
            setAcceptCookie(true)
            setAcceptThirdPartyCookies(webView, true)
        }

        // Present a consistent mobile Chrome identity (reCAPTCHA cares — see SPIKE.md risks).
        ...
        webView.webViewClient = EvilLiteWebViewClient(bridge)
    ...
    companion object {
        const val ENTRY_URL = "https://evilquest.net/__evillite__/client.html"
        // Placeholder; finalise against a real device UA during the spike.
